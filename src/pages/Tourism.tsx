    ...
    <div className="space-y-10">
      <header className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-emerald-500 via-cyan-500 to-blue-500 p-10 text-white shadow-2xl">
        ...
        <div className="relative z-10 space-y-3">
          ...
          <p className="pill inline-block bg-white/20 border border-white/40 text-xs font-semibold tracking-wide text-white">Lugares turísticos</p>
          <h1 className="font-display text-4xl md:text-5xl font-black drop-shadow-lg">Naturaleza y aventura en Osa</h1>
          <p className="max-w-3xl text-lg text-emerald-50">Playas vírgenes, selva tropical, manglares y la biodiversidad más rica de Costa Rica.</p>
