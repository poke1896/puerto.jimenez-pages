          ...
          return (
            ...
            >
              ...
              >
                ...
                <div className={`text-sand/70 transition-transform duration-300 ${isOpen ? 'rotate-180' : ''}`}>
                  ▼
                </div>
              </button>
                    ...
                    {category.places.map((place) => {
                      ...
                      return (
                        <a
                          ...
                          className="glass-card group cursor-pointer border border-white/10 p-4 transition-all duration-300 hover:scale-[1.02] hover:shadow-glow hover:bg-white/5"
                        >
                          <div className="flex items-start justify-between gap-3">
                            <h3 className="font-semibold text-sand transition-colors group-hover:text-white">
                              {place.name}
                            </h3>
                            <span className="text-xs font-semibold uppercase tracking-[0.18em] text-sand/70">
